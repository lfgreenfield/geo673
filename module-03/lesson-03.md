...
These CSS rules will expand that `div` element holding our Leaflet map to the entire viewport of the browser window. This way, when for example we've loaded a tileset into our map, it will look like this:
